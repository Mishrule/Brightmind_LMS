						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; white-space: nowrap; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
									<!-- Better Education For IT Students  -->
							</div>
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								This is a self-paced LMS that will help you to learn any course that you want from this site at your own pace.
							</div>
							<!-- LAYER NR. 4 -->
							<div class="tp-caption Newspaper-Button rev-btn " 
								...
								style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:var(--primary) !important; border:0; border-radius:30px; margin-right:5px;">DOWNLOAD </div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								...
								<div class="info-bx text-center">
									...
									<h4><a href="#">Top Industry Leaders</a></h4>
                ...
                <div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx left">
							...
							<p>This is a self-paced LMS that will help you to learn any course that you want from this site at your own pace.</p>
						</div>
					</div>
					<div class="row">
					<div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
						<div class="item">
							<div class="cours-bx">
								...
								<div class="info-bx text-center">
									<h5><a href="#">Fundamentals Of Programming</a></h5>
									<span>Level 100</span>
								</div>
						...
						<div class="item">
							<div class="cours-bx">
								...
								<div class="info-bx text-center">
									<h5><a href="#">Data Structures & Algorithms</a></h5>
									<span>Level 200</span>
								</div>
								<div class="cours-more-info">
									<div class="review">
						...
						<div class="item">
							<div class="cours-bx">
								...
								<div class="info-bx text-center">
									<h5><a href="#">Numerical Methods and Computation</a></h5>
									<span>Level 300</span>
								</div>
								<div class="cours-more-info">
									<div class="review">
						...
						<div class="item">
							<div class="cours-bx">
								...
								<div class="info-bx text-center">
									<h5><a href="#">Digital Media Production</a></h5>
									<span>Level 400</span>
								</div>
								<div class="cours-more-info">
									<div class="review">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center text-white">
							...
							<h5>Learn New Skills Online at Your Own Pace</h5>
						...
						<div class="row">
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-user"></i><span class="counter">13</span>C</h3>
									</div>
									<span class="cours-search-text">39 Credit hours in Level 100</span>
								</div>
							</div>
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-book"></i><span class="counter">14</span>C</h3>
									</div>
									<span class="cours-search-text">42 Credit hours in Level 200</span>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-layout-list-post"></i><span class="counter">14</span>C</h3>
									</div>
									<span class="cours-search-text">42 Credit hours in Level 300</span>
								</div>
							</div>
						</div>
					</div>
                ...
                <div class="container">
					<div class="row">
						<div class="col-md-12 text-white heading-bx left">
							...
							<p>This is what some of our cherished alumni have to say about us.</p>
						</div>
					</div>
						...
						<div class="item">
							<div class="testimonial-bx">
								...
								<div class="testimonial-info">
									<h5 class="name">Daniel Sedem Sini</h5>
									<p>-IT Personnel</p>
								</div>
								<div class="testimonial-content">
									<p>Bright Minds LMS is probably one of the world’s best websites to learn online and very self-paced.</p>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-bx">
								...
								<div class="testimonial-info">
									<h5 class="name">Paniella Hilson</h5>
									<p>-Art Director</p>
								</div>
								<div class="testimonial-content">
									<p>It’s a very easy to use website, offers good and quality courses and of course very affordable as compared to others.</p>
								</div>
							</div>
						</div>
					</div>
